...
using System.Linq;
using Android.Views;
using DayVsNight.Effects;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;


[assembly: ResolutionGroupName("DayVsNight")]
[assembly: ExportEffect(typeof(DayVsNight.Droid.Effects.TouchEffect), "TouchEffect")]

namespace DayVsNight.Droid.Effects
{
    public class TouchEffect : PlatformEffect
    {
        Android.Views.View view;
        Element formsElement;
        DayVsNight.Effects.TouchEffect libTouchEffect;
        bool capture;
        ...
        protected override void OnAttached()
        {
            ...
            DayVsNight.Effects.TouchEffect touchEffect =
                (DayVsNight.Effects.TouchEffect)Element.Effects.
                    FirstOrDefault(e => e is DayVsNight.Effects.TouchEffect);
